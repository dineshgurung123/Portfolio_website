    ...
    <div class="container">
        ...
        <div class="content">
            <div class="intro">
                ...
                <p>I am an enthusiastic and aspiring software developer with a solid foundation in programming languages like Java, C, C++ and web technologies such as HTML, CSS, JavaScript, React.js, and PHP. Currently, I am focusing on expanding my knowledge in web development.</p>
            </div>
